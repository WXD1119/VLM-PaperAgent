...
|---|---:|---:|---:|
| BM25 | 0.1875 | 0.8047 | 0.4917 |
| BGE-M3 Dense | 0.3828 | 0.7734 | 0.6406 |
| BM25 + BGE-M3 + RRF | **0.4766** | **0.8438** | **0.7208** |

RRF在三项指标上均为最佳；相对BM25，Recall@1提高0.2891，Recall@5提高0.0391，MRR提高0.2291。该数据集用于开发阶段消融，后续仍需独立留出集。
